...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        compute_workspace_card_areas_from_layout, expanded_sidebar_sections,
        expanded_sidebar_toggle_rect, jobs_list_scroll_metrics, normalized_workspace_scroll,
        sidebar_section_divider_rect, sidebar_section_ratio_for_row, workspace_drop_slots,
...
fn render_navigation_chrome(
    ...
    if app.view.layout == ViewLayout::Mobile {
        ...
        if app.sidebar_collapsed {
            render_sidebar_collapsed(app, frame, app.view.sidebar_rect, &app.view.sidebar_layout);
        } else {
            render_sidebar(
                app,
                terminal_runtimes,
